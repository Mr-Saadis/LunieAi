...
import { Loader2, Mail, Lock, User, Eye, EyeOff, Check, X, Sparkles, Rocket } from 'lucide-react'
...
export default function SignupForm() {
  ...
  const handleOAuthSignup = async (provider) => {
    ...
    try {
      ...
      toast.error(`An error occurred with ${provider} sign up`)
        ...
        <div className="flex flex-col justify-center px-16 xl:px-20 w-full ml-8">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-600 font-light leading-relaxed mb-8 max-w-sm">
              Start building intelligent chatbots that transform your business
            </p>
          </div>
          ...
          <div className="text-gray-500 text-xs font-light max-w-xs">
            Join thousands of businesses already using LunieAI to enhance their customer experience
          </div>
        </div>
      </div>
            ...
            <div className="relative z-10">
              <div className="text-center space-y-2 mb-8">
                <div className="flex items-center justify-center gap-3 mb-2">
                  ...
                  <Badge className="bg-gradient-to-r from-[#F4CAF7] to-[#FB8A8F] text-white border-0 text-xs px-2 py-1">
                    Free Forever
                  </Badge>
                </div>
                <p className="text-gray-600 font-light">Join thousands of businesses using AI chatbots</p>
              </div>
              ...
              <div className="relative mb-6">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-white px-4 text-gray-400 font-medium">Or create with email</span>
                </div>
              </div>
              ...
              <form onSubmit={handleEmailSignup} className="space-y-5">
                <div className="space-y-2">
                  <Label htmlFor="fullName" className="text-sm text-gray-700 font-light">Full Name</Label>
                      ...
                      <div className="space-y-1">
                        {passwordRequirements.map((requirement, index) => (
                          <div key={index} className="flex items-center text-xs">
                            {requirement.met ? (
                              <div className="w-3 h-3 bg-green-100 rounded-full flex items-center justify-center mr-2">
                                <Check className="w-2 h-2 text-green-600" />
                              </div>
                            ) : (
                              <div className="w-3 h-3 bg-gray-100 rounded-full flex items-center justify-center mr-2">
                ...
                <Button
                  ...
                  disabled={loading || !isPasswordValid || oauthLoading.google || oauthLoading.microsoft}
                >
                  {loading ? (
                    <>
                      <Loader2 className="w-4 h-4 animate-spin mr-2" />
